    ...
    def execute(self, context: Any) -> str:
        ...
        try:
            ...
            with self.ssh_hook.get_conn() as ssh_client:
                ...
                filelist_specific_pattern=filelist_specific_pattern[:4]

                self.log.info(f"filelist_specific_pattern: {filelist_specific_pattern}")

                for idx, filename in enumerate(filelist_specific_pattern):
